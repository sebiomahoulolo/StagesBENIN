...
@section('title', 'Nouvelle demande d\'employé - StagesBENIN')
...
<div class="content-header">
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="h2 mb-0">Nouvelle demande d'employé</h1>
        <a href="{{ route('entreprises.demandes.index') }}" class="btn-outline-secondary">
...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="custom-card fade-in">
            <div class="card-body">
                <form action="{{ route('entreprises.demandes.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select class="form-control @error('type_demande') is-invalid @enderror" 
                                    ...
                                    <option value="employe" {{ old('type_demande') === 'employe' ? 'selected' : '' }}>Employé</option>
                                    <option value="stagiaire" {{ old('type_demande') === 'stagiaire' ? 'selected' : '' }}>Stagiaire</option>
                                </select>
                                @error('type_demande')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('nombre_postes') is-invalid @enderror" 
                                       id="nombre_postes" name="nombre_postes" value="{{ old('nombre_postes', 1) }}" min="1" required>
                                @error('nombre_postes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('description_poste') is-invalid @enderror" 
                                          id="description_poste" name="description_poste" rows="4" required>{{ old('description_poste') }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('experience_requise') is-invalid @enderror" 
                                    ...
                                    <option value="Débutant" {{ old('experience_requise') === 'Débutant' ? 'selected' : '' }}>Débutant</option>
                                    <option value="1-2 ans" {{ old('experience_requise') === '1-2 ans' ? 'selected' : '' }}>1-2 ans</option>
                                    <option value="3-5 ans" {{ old('experience_requise') === '3-5 ans' ? 'selected' : '' }}>3-5 ans</option>
                                    <option value="5-10 ans" {{ old('experience_requise') === '5-10 ans' ? 'selected' : '' }}>5-10 ans</option>
                                    <option value="10+ ans" {{ old('experience_requise') === '10+ ans' ? 'selected' : '' }}>10+ ans</option>
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <input type="hidden" name="competences_requises" id="competences-hidden" value="{{ old('competences_requises') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('salaire_propose') is-invalid @enderror" 
                                       id="salaire_propose" name="salaire_propose" value="{{ old('salaire_propose') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('lieu_travail') is-invalid @enderror" 
                                       id="lieu_travail" name="lieu_travail" value="{{ old('lieu_travail') }}" required>
                                @error('lieu_travail')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control @error('date_debut_souhaitee') is-invalid @enderror" 
                                       id="date_debut_souhaitee" name="date_debut_souhaitee" value="{{ old('date_debut_souhaitee') }}" required>
                            ...
                            <div class="col-md-6">
                                <label for="avantages" class="form-label">Avantages proposés</label>
                                <textarea class="form-control @error('avantages') is-invalid @enderror" 
                                        id="avantages" name="avantages">{{ old('avantages') }}</textarea>
                                @error('avantages')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-help-text">
                                    Décrivez les avantages supplémentaires liés au poste (tickets restaurant, télétravail, assurance santé, etc.)
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function renderCompetences() {
        competencesContainer.innerHTML = competences.map(competence => `
            <div class="competence-tag">
                ${competence}
                <button type="button" onclick="removeCompetence('${competence.replace(/'/g, "\\'")}')">
