    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('entreprises.evenements.update', $event) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            @endif
                            <label for="image" class="form-label">Nouvelle image de l'événement</label>
                        ...
                        <div class="alert alert-info">
                            ...
                            Les modifications seront soumises à validation avant d'être publiées.
                        </div>
