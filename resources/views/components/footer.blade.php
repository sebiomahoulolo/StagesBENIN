    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 col-lg-3 col-md-6 mb-4"> {{-- col-6 pour mobile, col-lg-3 pour grand écran --}}
                <a href="{{ url('/') }}">
                    {{-- Ajout de img-fluid pour la responsivité et un max-width pour contrôle --}}
                    <img src="{{ asset('assets/images/stagebenin.png') }}" alt="StagesBENIN Logo Footer" class="footer-logo mb-3 img-fluid" style="max-width: 200px;">
                </a>
