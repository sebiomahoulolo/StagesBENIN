...
<body x-data="{ isSidebarOpen: false }" {{-- Bloque le scroll du body uniquement quand la sidebar est ouverte ET qu'on est sur un petit écran --}}
    :class="{ 'overflow-hidden': isSidebarOpen && window.innerWidth < 992 }" class="@stack('body-class')">
