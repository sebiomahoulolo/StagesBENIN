        ...
        <div class="action-bar d-flex justify-content-between align-items-center">
            ...
            <div class="action-buttons">
                ...
                <input type="text" id="searchInput" class="form-control ms-3"
                    placeholder="Rechercher par nom, secteur, email ou téléphone...">
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1 flex-wrap">
                                        ...
                                        <a href="{{-- {{ route('entreprises.contact', $entreprise->id) }} --}}" class="btn btn-primary btn-sm"
                                            data-bs-toggle="tooltip" title="Contacter"><i class="fas fa-envelope"></i></a>
                                        <a href="{{ route('entreprises.follow', $entreprise->id) }}"
                                            class="btn btn-success btn-sm" data-bs-toggle="tooltip" title="Suivre"><i
                                                class="fas fa-star"></i></a>
                                        <a href="{{-- {{ route('entreprises.edit', $entreprise->id) }} --}}" class="btn btn-warning btn-sm"
                                            data-bs-toggle="tooltip" title="Modifier"><i class="fas fa-edit"></i></a>
