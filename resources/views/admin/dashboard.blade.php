    ...
    <style>
        ...
        *::after {
        ...
        body {
            ...
            padding: 20px;
            /* Ajoute un peu d'espace autour du conteneur */
            background-color: #f4f7f6;
            /* Un fond léger pour contraster */
        }
        ...
        .styled-link-box {
            display: flex;
            /* Pour aligner icône et texte */
            align-items: center;
            /* Centrage vertical */
            padding: 15px 20px;
            /* Padding intérieur (plus grand) */
            ...
            overflow: hidden;
            /* Empêche le contenu de déborder si le texte est trop long */
            word-break: break-word;
            /* Coupe les mots longs si nécessaire */
        }
        ...
        .styled-link-box i {
            ...
            font-size: 1.2em;
            /* Taille de l'icône légèrement augmentée */
            width: 25px;
            /* Donne une largeur fixe pour un meilleur alignement */
            text-align: center;
        }
        ...
        .styled-link-box:hover {
            ...
            /* Assombrir un peu la bordure bleue */
        }
